...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "Quando o usuário pedir para consultar a bateria, controlar LEDs, controlar os olhos ou mover a cabeça, use a tool correspondente em vez de apenas descrever a ação. "
